Assessment Task
Objective: Build a simple page for managing a To-Do List using HTML, CSS and JavaScript.
Instructions:
Create a simple HTML page with
A header of "To-Do List"
An input field where users can type in a new task.
A button to add the task to the list.
A list that displays the tasks.
Each task should have a checkbox to mark it as completed and a delete button to remove the task.
Style the page
Style the page however you like, keeping the layout responsive.
Take accessibility into consideration
Add Functionality
When the user types in the input field and clicks the "Add" button, the task should be added to the list.
